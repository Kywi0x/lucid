...
/** Viewer des spaces partagés (GitHub Pages, cf. .github/workflows/pages.yml) —
 *  URL publique, même logique de fallback que ci-dessus. */
export const DEFAULT_SHARE_URL = "https://kywi0x.github.io/lucid/s";
